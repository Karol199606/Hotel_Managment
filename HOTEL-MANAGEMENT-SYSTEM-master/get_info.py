...
class GetInfo:
    def __init__(self, root):
        ...
        # okienko informację o gosciach
        self.label = Label(top, font=('arial', 50, 'bold'), text="Informacje o gościach", fg="#15d3ba",
                           anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # okno wprowadz numer pokoju
        self.room_no_label = Label(bottom, font=('arial', 20, 'bold'), text="wprowadz numer pokoju :", fg="#15d3ba",
                                   anchor="center")
        ...
        # stworzenie guzika zatwierdz
        self.submit_button = Button(button_frame, text="zatwierdz", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2,
                                    width=15, fg="black", anchor="center", command=get_info)
        self.submit_button.grid(row=8, column=2, padx=10, pady=10)

        # stworzenie guzika powrotu do menu
        self.home_button = Button(button_frame, text="menu", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2,
