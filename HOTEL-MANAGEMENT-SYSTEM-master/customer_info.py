...
class CustomerInfo:
    def __init__(self, root):
        self.root = root
        pad = 3
        self.root.title("Informacje o gosciach")
        self.root.geometry(
        ...
        # okno lista gosci
        self.label = Label(top, font=('arial', 50, 'bold'), text="Lista gosci", fg="#15d3ba", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # okno imię
        self.name_label = Label(left, font=('arial', 20, 'bold'), text="Imię", fg="#15d3ba", anchor="center")
        ...
        # okno numer pokoju
        self.room_no_label = Label(right, font=('arial', 20, 'bold'), text="Numer pokoju", fg="#15d3ba", anchor="center")
        ...
        # stworz guzik menu
        self.home_button = Button(top, text="Menu", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2, width=15,
        ...
        # guzik wyswietl
        self.display_button = Button(top, text="Wyswietl", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2, width=15,
